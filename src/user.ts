...
export function playerIsUser (player: Player): player is User & { rel: "user"; } { return 'id' in player; }
/** Type guard to check if user.location is null or not. */
export function userLocationNotNull (user: User): user is User & { location: UserLocation; } { return user.location !== null; }