 ...
 * @param options Options for the HTTP request itself.
 */
export async function getAllLevelRecords<Embed extends string = "", S = Leaderboard<Embed>>(level: string, queryParams?: LevelRecordsParams<Embed>, options?: PaginatedGetOptions<Leaderboard<Embed>, S>) {
