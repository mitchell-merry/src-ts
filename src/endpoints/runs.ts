 ...
 */
export async function getAllRuns<Embed extends string = "", S = Run<Embed>>(queryParams?: RunsParams<Embed>, options?: PaginatedGetOptions<Run<Embed>, S>): Promise<Awaited<S>[]> {
