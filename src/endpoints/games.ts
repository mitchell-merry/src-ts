 ...
 * @param options Options for the HTTP request itself.
*/
export async function getAllGames<Embed extends string = "", S = Game<Embed>>(queryParams?: GamesParams<Embed>, options?: PaginatedGetOptions<Game<Embed>, S>) {
 ...
 * @param options Options for the HTTP request itself.
 */
export async function getAllGameRecords<Embed extends string = "", S = Leaderboard<Embed>>(game: string, queryParams?: GameRecordsParams<Embed>, options?: PaginatedGetOptions<Leaderboard<Embed>, S>) {
